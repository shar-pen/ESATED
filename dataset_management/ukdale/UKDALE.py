...
class UKDALE():
    ...
    def to_Dataframe_V1(self, Houses:list, Appliances:list=[], sample_seconds=6, only_first:bool=True, summed:bool=False):
        ...
        for h in Houses:
            ...
            # appliance
            if Appliances == []:
                Appliances = unique_order_preserved(labels['appliance_name'])
            df_list = []
